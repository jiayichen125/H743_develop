...
extern TIM_HandleTypeDef htim3;  /* ���ڶ�̬�л������� */
...
{
    static float cur = 100000.0f;  /* �� MX_TIM3_Init ARR=199 ��Ӧ */
...
/* ֱ���޸� TIM3->ARR����ͣ��ʱ������һ֡ DMA ����Ч
 * ע�⣺2MHz ����ARR=9��Ҫ�� ADC ��ת��ʱ�� < 500ns����ȷ�� ADC �ں�ʱ�� */
